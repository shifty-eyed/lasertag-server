...
public class ActorRegistry {
	...
	public ActorRegistry() {// this should be in config screen before running the game
		...
		actors.add(new Dispenser(2, Actor.Type.AMMO_DISPENSER));

		actors.add(new Dispenser(1, Actor.Type.HEALTH_DISPENSER));
		actors.add(new Dispenser(2, Actor.Type.HEALTH_DISPENSER));
	}

	private Stream<Actor> streamByType(Actor.Type type) {
